            ...
            [
                {
                    ...
                    "potentialAction": {
                        "@type": "SearchAction",
                        "target": "https://www.damaiagungflorist.com/products?search={search_term_string}",
                ...
                },
                {
                    "@context": "https://schema.org",
                    "@type": "LocalBusiness",
                    "@id": "https://www.damaiagungflorist.com#LocalBusiness",
                    "url": "https://www.damaiagungflorist.com",
                    "name": "Damai Agung Florist",
                    "description": "Cari toko bunga di Tangerang? Damai Agung Florist menyediakan bunga segar untuk berbagai acara. Hubungi kami sekarang!",
                    "address": {
                        "@type": "PostalAddress",
                        "streetAddress": "Jl. Eksekusi 2 Blok E2 No.8, RT.001/RW.008, Sukasari, Kec. Tangerang",
                    ...
                    "founder": {
                        "@type": "Person",
                        "name": "Anita Putri Lestari"
                    },
                    "sameAs": [
                        "https://www.facebook.com/damaiagungflorist/",
                        "https://www.instagram.com/damaiagungflorist/"
                    ],
                    "aggregateRating": {
                ...
                },
                {
                    ...
                    "contactPoint": {
                        ...
                        "contactType": "sales",
                        "telephone": ["+6283813735071", "+6282310498541"],
                        "url": "https://www.damaiagungflorist.com/kontak-kami/"
                    }
                }
            ]
        </script>
                    ...
                    <div class="flex space-x-4">
                        @foreach ($options->where('type', 'sosial media') as $item)
                            <a href="{{ $item->key === 'whatsapp' ? "https://wa.me/{$item->value}" : $item->value }}"
                                class="social-icon" data-tooltip="{{ $item->key }}">
